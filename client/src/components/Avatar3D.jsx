...
export const CHARACTER_MODELS = [
  {
    id: "male-a",
    name: "Casual",
    file: "/models/character-male-a.glb",
    gender: "male",
  },
  {
    id: "male-b",
    name: "Athlete",
    file: "/models/character-male-b.glb",
    gender: "male",
  },
  {
    id: "male-c",
    name: "Police",
    file: "/models/character-male-c.glb",
    gender: "male",
  },
  {
    id: "male-d",
    name: "Gamer",
    file: "/models/character-male-d.glb",
    gender: "male",
  },
  {
    id: "male-e",
    name: "Punk",
    file: "/models/character-male-e.glb",
    gender: "male",
  },
  {
    id: "male-f",
    name: "Adventurer",
    file: "/models/character-male-f.glb",
    gender: "male",
  },
  {
    id: "female-a",
    name: "Sporty",
    file: "/models/character-female-a.glb",
    gender: "female",
  },
  {
    id: "female-b",
    name: "Trendy",
    file: "/models/character-female-b.glb",
    gender: "female",
  },
  {
    id: "female-c",
    name: "Office",
    file: "/models/character-female-c.glb",
    gender: "female",
  },
  {
    id: "female-d",
    name: "Pigtails",
    file: "/models/character-female-d.glb",
    gender: "female",
  },
  {
    id: "female-e",
    name: "Curly",
    file: "/models/character-female-e.glb",
    gender: "female",
  },
  {
    id: "female-f",
    name: "Bun",
    file: "/models/character-female-f.glb",
    gender: "female",
  },
];
    ...
    if (groupRef.current) {
      ...
      if (bobbing) {
        groupRef.current.position.y =
          Math.sin(state.clock.elapsedTime * 2.5) * 0.03;
      }
    }
  });
...
export function Avatar3DModel({
  ...
  const character =
    CHARACTER_MODELS.find((c) => c.id === characterId) || CHARACTER_MODELS[0];
